...
function MapController({
  ...
  }, [map, selectedStop, selectedStopIndex]);

  useEffect(() => {
    if ((isNavigating || followUser) && userLocation) {
      map.setView(userLocation, 16, { animate: true });
    }
  }, [map, userLocation, followUser, isNavigating]);
    ...
    <div className="tour-layout">
      <button
        ...
        className={`panel-toggle-button ${
          isPanelOpen ? "panel-toggle-open" : "panel-toggle-closed"
        }`}
      ...
      <aside
        className={`stop-panel ${isMobile ? "stop-panel-mobile" : ""} ${
          isPanelOpen ? "stop-panel-open" : "stop-panel-closed"
        }`}
      >
                ...
                <div className="stop-card-top">
                  ...
                  <div
                    className={`stop-badge ${
                      isUnlocked ? "stop-badge-unlocked" : "stop-badge-locked"
                    }`}
                  >
